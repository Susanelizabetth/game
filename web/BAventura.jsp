<%-- 
    Document   : BAventura.
    Created on : 07/26/2021, 4:16:05 p. m.
    Author     : susan
--%>
...
<html lang="en,es" dir="ltr">
   <head>
      ...
      <%
        ...
        List<Producto> productos = productosDb.GetAventura();
      ...
      <div class="sidebar">
         ...
         <a class="active" href="BAventura.jsp">Aventura</a>
      ...
      <div class="container-b">
         <h4 class="title">Juegos de Aventura</h4>
         <div class="row-b">
