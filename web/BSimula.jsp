...
<html lang="en,es" dir="ltr">
   <head>
      ...
      <%
        ...
        List<Producto> productos = productosDb.GetSimula();
      ...
      <div class="sidebar">
         ...
         <a href="Busquda.jsp">Populares</a>
         <a href="BDisparos.jsp">Disparos</a>
         <a href="BAventura.jsp">Aventura</a>
         <a class="active" href="BSimula.jsp">Simuladores</a>
      </div>
      ...
      <div class="container-b">
         <h4 class="title">Juegos de Simluación</h4>
         <div class="row-b">
